...
public class GenerateHandwriting {
    ...
    private final ArrayList<String> textFromFile;
    private final HashMap<Character , Integer> alphabet;
    private final HashMap<Integer , int[][]> data;
    public int[][] result;
        ...
        for (String s : textFromFile) {
            ...
            for (int i = 0; i < s.length(); i++) {
                try {
                    ...
                    System.out.println(s.charAt(i) + " " + s);
                    continue;
                }
    ...
    static void writeFinalGeneratedImage(BufferedImage writeImage, int file) {
